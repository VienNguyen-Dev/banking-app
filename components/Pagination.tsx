...
const Pagination = ({ page, totalPages }: PaginationProps) => {
  ...
  return (
    <div className="flex justify-between">
      <Button disabled={page <= 1} variant={"outline"} className="flex gap-2" onClick={() => handleNagigation("prev")}>
      ...
      <Button disabled={page >= totalPages} variant={"outline"} className="flex gap-2" onClick={() => handleNagigation("next")}>
        Next
